...
/**
 * This is the base model class for table "{{%expences}}".
 *
 * @property integer $id
...
/**
    ...
    /**
     * @inheritdoc
     * @return \app\models\ExpencesQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\ExpencesQuery(get_called_class());
    }
}
