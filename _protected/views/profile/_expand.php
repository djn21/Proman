...
$items = [
    [
        ...
        [
        'label' => '<i class="glyphicon glyphicon-book"></i> '. Html::encode('Activity Profile'),
        'content' => $this->render('_dataActivityProfile', [
            ...
            'row' => $model->activityProfiles,
                ...
                [
        'label' => '<i class="glyphicon glyphicon-book"></i> '. Html::encode('Project Profile'),
        'content' => $this->render('_dataProjectProfile', [
            ...
            [
        'label' => '<i class="glyphicon glyphicon-book"></i> '. Html::encode('Task Profile'),
